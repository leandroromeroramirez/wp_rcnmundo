...
<?php /*?><script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/dfp/js/invoke.js?v=1"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/dfp/js/home.js?v1"></script><?php */?>
    ...
    <section class="content_station">
        <div class="row">
            ...
            <main class="col-md-9 col-sm-8">
                ...
                <div id="media">
                    <audio id="emisoraaudio" controls style="z-index:1; position:absolute; top:30px; left:3px; display:none; width:1px;">
                        <source src="" type="audio/mpeg"  id="radio_main_channel" /></audio>
                    <?php /*?><div id="stream"></div><?php */?>
                <?php if (is_single(7)) { ?>
                    <h2>EStamos aqui</h2>
...
<style>#vap<?php the_ID(); ?> { font-size:100%; } #vap<?php the_ID(); ?>.vjs-default-skin { color: #CCCCCC; }#vap<?php the_ID(); ?>.vjs-default-skin .vjs-play-progress, #vap<?php the_ID(); ?>.vjs-default-skin .vjs-volume-level { background-color: #0C70B4; }#vap<?php the_ID(); ?>.vjs-default-skin .vjs-control-bar, #vap<?php the_ID(); ?>.vjs-default-skin .vjs-big-play-button { background: rgba(0,0,0,0.7); }#vap<?php the_ID(); ?>.vjs-default-skin .vjs-slider { background: rgba(0,0,0,0.2333333333333333) } </style>
	...
	<div class="video-wrapper " style=" height:470px; padding-bottom: 0px;">
		<audio id="vapWagner" class="video-js vjs-default-skin vjs-big-play-centered vjs-controls-enabled vjs-live" controls preload="auto" width="100%" height="270" data-setup='{}' autoplay >
            <source id="mp4src" src="<?php echo $urlstream; ?>" type='video/mp4' />
