                                ...
                                <div class="carousel-inner" role="listbox">
                                  <div class="item active">
                                    <div class="sm_station">
                                                                                    <img src="http://www.rcnmundo.com/wp-content/uploads/2015/09/elsol-60x60.png" class="logoRadio" />
                                                                                    <div class="nowstation"><p></p></div>
                                            <div class="panelradio">
                                                <h1>105.4 FM</h1><h2>El Sol</h2>
                                                <span><a href="http://http://www.elsol.com.co/" target="_blank">http://www.elsol.com.co/</a></span>
                                            </div>
                                            <div class="zocalo">
...
<script src="http://www.rcnmundo.com/wp-content/themes/rcnmundo/js/jquery.dfp.js"></script>
    <script type="text/javascript">
        ...
        function nowstation(){
            $.ajax({
              type:     "GET",
              url:      "http://www.rcnmundo.com/cover_new.php?id=64",
        ...
        playerInstance.setup({
                primary:'html5',
                file: 'http://live.rcnmundo.com/rumba.aac' ,
                autostart: true,
                width: "100%",
                height: 350,
                skin: "stormtrooper",
...
<!-- Cached page generated by WP-Super-Cache on 2017-09-26 15:20:29 -->
