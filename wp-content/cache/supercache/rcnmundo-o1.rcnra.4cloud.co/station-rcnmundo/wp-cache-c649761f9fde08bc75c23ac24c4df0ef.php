...
<body class="tagwindow radio-antena2">
	<div class="container">
    	<div class="row">
            <main>
                <div id="media">
                                ...
                                <div class="carousel-inner" role="listbox">
                                  <div class="item active">
                                    <div class="sm_station">
                                                                                    <img src="http://www.rcnmundo.com/wp-content/uploads/2015/10/logo_antena2-60x60.png" class="logoRadio" />
                                                                                    <div class="nowstation"><p></p></div>
                                            <div class="panelradio">
                                                <h1>650 AM</h1><h2>ANTENA 2</h2>
                                                <span><a href="http://http://www.antena2.com.co/" target="_blank">http://www.antena2.com.co/</a></span>
                                            </div>
                                            <div class="zocalo">
...
<script src="http://www.rcnmundo.com/wp-content/themes/rcnmundo/js/jquery.dfp.js"></script>
    <script type="text/javascript">
        ...
        function nowstation(){
            $.ajax({
              type:     "GET",
              url:      "http://www.rcnmundo.com/cover_new.php?id=24",
        ...
        playerInstance.setup({
                primary:'html5',
                file: 'http://live.rcnmundo.com/antena2.aac' ,
                autostart: true,
                width: "100%",
                height: 350,
                skin: "stormtrooper",
...
<!-- Cached page generated by WP-Super-Cache on 2017-09-26 15:11:05 -->
