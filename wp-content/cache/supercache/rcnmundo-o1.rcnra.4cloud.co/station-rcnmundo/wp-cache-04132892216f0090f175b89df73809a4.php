...
<body class="tagwindow radio-rcnradio">
	<div class="container">
    	<div class="row">
            <main>
                <div id="media">
                                ...
                                <div class="carousel-inner" role="listbox">
                                  <div class="item active">
                                    <div class="sm_station">
                                                                                    <img src="http://www.rcnmundo.com/wp-content/uploads/2015/09/rcnradio_logo-60x60.png" class="logoRadio" />
                                                                                    <div class="nowstation"><p></p></div>
                                            <div class="panelradio">
                                                <h1>93.9 FM</h1><h2>RCN RADIO</h2>
                                                <span><a href="http://http://www.rcnradio.com/" target="_blank">http://www.rcnradio.com/</a></span>
                                            </div>
                                            <div class="zocalo">
...
<script src="http://www.rcnmundo.com/wp-content/themes/rcnmundo/js/jquery.dfp.js"></script>
    <script type="text/javascript">
        ...
        function nowstation(){
            $.ajax({
              type:     "GET",
              url:      "http://www.rcnmundo.com/cover_new.php?id=4",
        ...
        playerInstance.setup({
                primary:'html5',
                file: 'http://live.rcnmundo.com/rcnradio.aac' ,
                autostart: true,
                width: "100%",
                height: 350,
                skin: "stormtrooper",
        ...
        setInterval(function(){ nowstation(001);},5000);
    </script>
</body>
</html>

<!-- Dynamic page generated in 0.118 seconds. -->
<!-- Cached page generated by WP-Super-Cache on 2017-09-26 15:19:13 -->
